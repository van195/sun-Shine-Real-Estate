...
export const FeatureCard = ({onPress}) => {
  return (
    <TouchableOpacity onPress={onPress} style={{marginTop:-20,flex:1,flexDirection:'column',alignItems:'flex-start', width:200, height:200 ,position:'relative'}}>
      <Image source={images.japan} style={{width:'90%', height:'100%', borderRadius:15}}/>
      <Image source={images.cardGradient} style={{width:'90%', height:'100%', borderRadius:15,position:'absolute',top:0,left:0}}/>
      ...
      <View style={{width:100,  flex:1, flexDirection:'column',alignItems:'flex-start' ,position:'absolute',left:20, top:110}}>
        ...
        <Image source={icons.heart } style={{width:20, height:20,position:'absolute',bottom:0,left:120}}/>
      </View>
    </TouchableOpacity>
  )
}
...
export const Card = ({onPress}) => {
  return (
    <TouchableOpacity onPress={onPress} style={{width:'100%' , height:250, backgroundColor:'#fff', padding:10,marginTop:-150, elevation:4 , flex:1, position:'relative'}}>
        ...
        <View style={{width:100,  flex:1, flexDirection:'column',alignItems:'flex-start' ,position:'absolute',left:15, top:160}}>
            ...
            <Image source={icons.heart } tintColor='#000' style={{width:20, height:20,position:'absolute',top:60,left:110}}/>
      </View>
    </TouchableOpacity>
  )
}
